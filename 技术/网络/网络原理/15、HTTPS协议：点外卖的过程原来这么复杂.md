...
|   |   |   |   |
|---|---|---|---|
||openssl x509 -req -in cliu8sitecertificate.req -CA cacertificate.pem -CAkey caprivate.key -out cliu8sitecertificate.pem||openssl x509 -req -in cliu8sitecertificate.req -CA cacertificate.pem -CAkey caprivate.key -out cliu8sitecertificate.pem|
...
|   |   |   |   |
|---|---|---|---|
||openssl x509 -in cliu8sitecertificate.pem -noout -text||openssl x509 -in cliu8sitecertificate.pem -noout -text|
...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/2725209/1632989155566-c107568a-9cc3-4756-bd18-e05639ddee2a.jpeg)
