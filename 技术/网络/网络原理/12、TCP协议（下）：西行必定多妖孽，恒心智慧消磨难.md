...
于是，发送端需要保持下面的数据结构。
![[Pasted image 20230525110811.png]]
...
对应的数据结构就像这样。
![[Pasted image 20230525111907.png]]
...
![[Pasted image 20230525111945.png]]
这个新的窗口 8 通过 6 的确认消息到达发送端的时候，你会发现窗口没有平行右移，而是仅仅左面的边右移了，窗口的大小从 9 改成了 8。
![[Pasted image 20230525111957.png]]
如果接收端还是一直不处理数据，则随着确认的包越来越多，窗口越来越小，直到为 0。
![[Pasted image 20230525112009.png]]
当这个窗口通过包 14 的确认到达发送端的时候，发送端的窗口也调整为 0，停止发送。
![[Pasted image 20230525112016.png]]
...
![[Pasted image 20230525112024.png]]
...
![[Pasted image 20230525112036.png]]
...
![[Pasted image 20230525112043.png]]
## 小结
