...
看到了吧，我们定义了两个副本（size=2），这里就出现了两个 Pod，还有一个 NodePort=30002 的 Service 对象，我们可以通过该端口去访问下应用：![crd nginx app demo](https://bxdc-static.oss-cn-beijing.aliyuncs.com/images/crd-nginx-app-demo.png)
