...
redis cluster，主要是针对海量数据+高并发+高可用的场景。redis cluster 支撑 N 个 redis master node，每个 master node 都可以挂载多个 slave node。这样整个 redis 就可以横向扩容了。如果你要支撑更[大数据](https://cloud.tencent.com/solution/bigdata?from=10680)量的缓存，那就横向扩容更多的 master 节点，每个 master 节点就能存放更多的数据了。
...
![](https://cdn.nlark.com/yuque/0/2021/png/2725209/1634093874108-4f9df6fa-86a0-4e88-bebb-aa38786e756d.png)

redis 维护集群元数据采用另一个方式， gossip 协议，所有节点都持有一份元数据，不同的节点如果出现了元数据的变更，就不断将元数据发送给其它的节点，让其它节点也进行元数据的变更。

![](https://cdn.nlark.com/yuque/0/2021/png/2725209/1634093867011-e3a017d4-e1e9-4d0b-b02c-48c4ff5551da.png)
...
来了一个 key，首先计算 hash 值，然后对节点数取模。然后打在不同的 master 节点上。一旦某一个 master 节点宕机，所有请求过来，都会基于最新的剩余 master 节点数去取模，尝试去取数据。这会导致大部分的请求过来，全部无法拿到有效的缓存，导致大量的流量涌入[数据库](https://cloud.tencent.com/solution/database?from=10680)。

![](https://cdn.nlark.com/yuque/0/2021/png/2725209/1634093856459-b1b812a6-89e5-4add-8810-385bc2966072.png)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2725209/1634093850290-a66dfc6e-14a1-4eba-88b8-4e5789291626.png)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2725209/1634093836084-7899fc4e-8a9f-4100-9c34-e6da4ebf3f0a.png)
