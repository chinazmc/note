...
考虑到参数非常繁多，一一说明工作量巨大，下面我只挑一些关键性的、非常实用和最常用的参数进行详细讲解。如果读者想要了解所有的参数细节，请参考阅读 [Redis 官网文档://redis.io/commands/info)。

## Redis 每秒执行多少次指令？

![[Pasted image 20230403195809.png]]
...
## Redis 内存占用多大 ?
![[Pasted image 20230403202028.png]]
